...
- DnD placeholders: pulsing animation for clear visual feedback; hovered drop target tile gets a stronger high-contrast dashed outline (no geometry reflow) for precise placement visibility
